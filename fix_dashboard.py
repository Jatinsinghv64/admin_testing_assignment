...
generate_code = """  bool _isGeneratingIngredients = false;
...
# 1. Remove all occurrences of generate_code completely
content = content.replace(generate_code, "")

# 2. Add it BACK to only the first occurrence of "@override\n  Widget build(BuildContext context) {"  (which corresponds to _DashboardScreenState)
