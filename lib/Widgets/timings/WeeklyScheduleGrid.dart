...
class WeeklyScheduleGrid extends StatelessWidget {
  final Map<String, List<Map<String, dynamic>>> schedule; // Day -> List of shifts
  ...
  final Function(String, int, Map<String, dynamic>) onUpdateShift; // Day, index, data
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 16),
              _buildLegendItem(context, 'UNDERSTAFFED', const Color(0xFFef4444)),
              const SizedBox(width: 16),
            ...
            child: Padding(
              ...
              child: !isOpen
                  ...
                  : Wrap(
                      ...
                      children: [
                        ...shifts.asMap().entries.map((entry) => _buildShiftBadge(context, day, entry.key, entry.value)).toList(),
  ...
  Widget _buildShiftBadge(BuildContext context, String day, int index, Map<String, dynamic> shift) {
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                onTap: () => onUpdateShift(day, index, shift),
                child: _buildStaffingBadge(context, staffCount, requiredStaff, isUnderstaffed),
              ),
              IconButton(
  ...
  Widget _buildStaffingBadge(BuildContext context, int count, int required, bool isUnderstaffed) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(isUnderstaffed ? Icons.group_off : Icons.badge, color: color, size: 10),
